                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 9, minWidth: 0 }}>
                      ...
                      <div style={{ minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 5, flexWrap: 'wrap' }}>
                          ...
                          {entry.tier === 'hunter' && <span style={{ fontSize: 9, fontWeight: 800, color: '#f59e0b', backgroundColor: 'rgba(245,158,11,0.12)', borderRadius: 8, padding: '1px 6px', flexShrink: 0 }}>⚡</span>}
                          {entry.tier === 'tracker' && <span style={{ fontSize: 9, fontWeight: 800, color: '#a78bfa', backgroundColor: 'rgba(139,92,246,0.12)', borderRadius: 8, padding: '1px 6px', flexShrink: 0 }}>🎯</span>}
                        </div>
                      </div>
                    </div>
